...
<svelte:head>
	<title>Privacy Policy | Taren</title>
	<meta name="description" content="Privacy Policy for Taren" />
</svelte:head>
...
<div class="min-h-screen bg-background text-foreground">
	<div class="mx-auto max-w-3xl px-6 py-20 lg:px-8">
		...
		<div class="prose prose-sm md:prose-base dark:prose-invert mt-12 max-w-none">
			<p>
				Your privacy is important to us. It is Taren's policy to respect your privacy regarding any
				information we may collect from you across our website, <a href="https://taren.io"
					>https://taren.io</a
