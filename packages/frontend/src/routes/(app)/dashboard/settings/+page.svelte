		...
		{:else}
			...
			<div class="max-w-2xl space-y-4">
				...
				<Card.Root>
					...
					<div class="gap-4">
						...
						<p
							class="rounded-b-xl border-t border-border bg-muted/20 px-5 py-3 text-sm text-muted-foreground"
						>
			...
			-->
				...
				<Card.Root class="border-red-500/30">
					...
					<div class="gap-4">
						<p
							class="rounded-b-xl border-t border-red-500/30 bg-red-500/5 px-5 py-3 text-sm text-muted-foreground"
						>
