	...
	<div class="flex-1 overflow-y-auto px-4 py-5 sm:px-6 md:px-8 md:py-6">
			...
			<div class="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
				...
				<Card.Root class="p-5">
					<div class="mb-3 flex items-center justify-between">
						...
						<Badge
							variant="outline"
							class="border-emerald-600 bg-emerald-600/20 text-emerald-500 hover:bg-emerald-600/20"
							>Active</Badge
						>
					</div>
				...
				<Card.Root class="p-5">
					...
					<p class="text-xl font-bold text-orange-400">TOTAL_JOBS</p>
				</Card.Root>
					...
					<div class="mb-3 flex items-center justify-between">
						...
						{#if authState.user.subscription_tier !== 'Professional'}
							<Button
								...
								variant="outline"
								size="sm"
								class="border-indigo-600/30 bg-indigo-600/10 text-indigo-400 hover:bg-indigo-600/20"
								>Upgrade</Button
							>
						{/if}
					</div>
		...
		{:else if authState.user}
			...
			<div class="mx-auto max-w-lg rounded-xl border border-border bg-card p-10 text-center">
				<div
					class="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-yellow-500/20"
				>
					<svg
