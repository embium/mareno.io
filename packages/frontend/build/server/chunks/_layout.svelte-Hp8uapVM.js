import { V as head, W as spread_props, X as attr, Y as stringify, Z as ensure_array_like, _ as attributes, $ as clsx, a0 as attr_class, a1 as attr_style } from './index2-D1ESINYy.js';
import { m as modeStorageKey, t as themeStorageKey, d as darkClassNames, l as lightClassNames, a as disableTransitions, b as themeColors, s as synchronousModeChanges, c as derivedMode } from './states.svelte-CK2yfPPg.js';
import { h as hasContext, g as getContext, s as setContext, r as run, e as escape_html } from './context-CU6onIa8.js';
import { t as toastState, S as SonnerState, c as cn } from './toast-state.svelte-DJTtrTAK.js';
...
function Mode_watcher_full($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head("4bed9y", $$renderer2, ($$renderer3) => {
      if (themeColors2) {
        $$renderer3.push("<!--[-->");
...
const favicon = "data:image/svg+xml;base64,";
...
function Toaster($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<section${attr("aria-label", `${stringify(containerAriaLabel)} ${stringify(hotkeyLabel)}`)}${attr("tabindex", -1)} aria-live="polite" aria-relevant="additions text" aria-atomic="false" class="svelte-1u1b411">`);
...
//# sourceMappingURL=_layout.svelte-Hp8uapVM.js.map
