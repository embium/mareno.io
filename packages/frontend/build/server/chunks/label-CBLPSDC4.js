import { a4 as bind_props, _ as attributes, $ as clsx, W as spread_props, a6 as props_id, a5 as derived, aa as clsx$1, ab as ATTACHMENT_KEY } from './index2-D1ESINYy.js';
  ...
  $$renderer.component(($$renderer2) => {
    ...
    if (type === "file") {
      ...
      $$renderer2.push(`<input${attributes(
        {
          "data-slot": dataSlot,
          class: clsx(cn("flex h-9 w-full min-w-0 rounded-md border border-input bg-transparent px-3 pt-1.5 text-sm font-medium shadow-xs ring-offset-background transition-[color,box-shadow] outline-none selection:bg-primary selection:text-primary-foreground placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 dark:bg-input/30", "focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50", "aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40", className)),
          type: "file",
          ...restProps
        },
        void 0,
...
export { BoxSymbol as B, Input as I, Label as L, createId as a, boxWith as b, createBitsAttrs as c, attachRef as d, getDataTransitionAttrs as e, boolToEmptyStrOrUndef as f, getDataOpenClosed as g, executeCallbacks as h, composeHandlers as i, isObject as j, isWritableSymbol as k, boxFrom as l, mergeProps as m, boxFlatten as n, isBox as o, isWritableBox as p, boolToTrueOrUndef as q, boolToStr as r, simpleBox as s, toReadonlyBox as t };
//# sourceMappingURL=label-CBLPSDC4.js.map
